...
func TestDefaultErrorMsg(t *testing.T) {
	...
	err1 := ge.DefaultErrorMsg(nil, "default message")
	if err1 == nil {
	...
	err3 = ge.DefaultErrorMsg(err3, "default message")
	if err3 == nil {
		t.Error("Expected an error, but got nil")
...
func TestPanicIfError(t *testing.T) {
	...
	func() {
		...
		ge.PanicIfError(errors.New("panic error"))
	}()
}
